function CDifficutlyMenu() {
  ...
  this._init = function () {
    ...
    if (DISABLE_SOUND_MOBILE === false || s_bMobile === false) {
      ...
      _pStartPosLang = {
        x: _pStartPosExit.x - oSpriteExit.width / 2 - 10,
        y: _pStartPosExit.y,
      };
    }
    ...
    _oButEasy.addEventListenerWithParams(
      ON_MOUSE_DOWN,
    ...
    _oButMedium.addEventListenerWithParams(
      ON_MOUSE_DOWN,
      this._onPressDownButDifficulty,
      this,
      MEDIUM
    ...
    _oButHard.addEventListenerWithParams(
      ON_MOUSE_DOWN,
      this._onPressDownButDifficulty,
      this,
      HARD
