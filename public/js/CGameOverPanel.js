function CGameOverPanel(oParentContainer) {
  ...
  this._init = function () {
    ...
    _oTextTitle = new CTLText(
      _oContainerPanel,
      iX + oSprite.width / 2 - iWidth / 2,
      oSprite.height / 2 - 100,
      iWidth,
      80,
      80,
      "center",
    ...
    _oTextScore = new CTLText(
      _oContainerPanel,
      iX + oSprite.width / 4 - iWidth / 2,
      oSprite.height / 2 - 110,
      800,
      100,
      40,
      "center",
...
function CNetGameOverPanel(oParentContainer) {
  var _aCbCompleted;
  var _aCbOwner;
  var _oListener;
