function CGfxButton(iXPos, iYPos, oSprite, oParentContainer) {
  ...
  this._initListener = function () {
    ...
    _oButton.addEventListener("mouseover", () => {
      createjs.Tween.get(_oButton, { override: true }).to(
        { alpha: 1 },
        1000,
    ...
    _oButton.addEventListener("mouseout", () => {
      createjs.Tween.get(_oButton, { override: true }).to(
        { alpha: 0.95 },
        1000,
        createjs.Ease.cubicOut
  ...
  this.buttonDown = function () {
    ...
    if (_fScaleX > 0) {
      _oButton.scaleX = _fScaleX * 0.99;
    } else {
      _oButton.scaleX = -_fScaleX * 0.99;
    }
    _oButton.scaleY = _fScaleY * 0.99;
  ...
  this.pulseAnimation = function () {
    _oTween = createjs.Tween.get(_oButton, { loop: -1, override: true })
      .to(
  ...
  this.trebleAnimation = function () {
    _oTween = createjs.Tween.get(_oButton, { loop: -1 })
