        ...
        <div class="vs-card-wraper">
            ...
            <div class="info-status-btn">
                <div class="bet-amount">
                    <img src="./img/usdIcon.svg" width="25%">
                    <div style="font-size: 150%;">${data.betamount}</div>
                </div>
                ${
                  data.players && typeof data.players[1] == "undefined"
                    ? `<button type="button" class="btn1 vs-card-btn" style="font-size: 15px;" onclick="s_oRoomList.joinRoom('${data.roomid}')">join</button>`
                    : `<button type="button" class="btn1 vs-card-btn" style="font-size: 15px;" onclick="s_oRoomList.spectator('${data.roomid}')">spectator</button>`
                }
            </div>
